<template>
	<view class="box">
		...
		<view class="box-content">
			...
			<view class="box-content-store-main" v-if="defaultIndex==0">
				<view class="box-content-store-list" v-if="isDateStore">
			...
			<view class="box-content-store-main" v-if="defaultIndex==1">
				<view class="box-content-technician-list" v-if="isDateTec">
					<view class="box-content-technician-list-li">
						<view class="box-content-item-technician-wrap">
							<view class="content-item-technician-wrap-list">
								<view class="content-item-technician-wrap-list-li" v-for="(item,index) in 5"
									:key="index" @click="technicianDetails(item)">
				...
				<view class="box-content-store-load" v-if="!isDateTec">
