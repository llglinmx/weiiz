<template>
	<view class="calendar-wrapper">
		<view class="header" :class="!monthOpen?'header-hidden':''" v-if="headerBar">
			<view class="pre" @click="changeMonth('pre')">
				<image src="../../static/images/left-icon.png" mode="aspectFill"></image>
			</view>
			<view class="header-date">{{y+'年'+formatNum(m)+'月'}}</view>
			<view class="next" @click="changeMonth('next')">
				<image src="../../static/images/right-icon.png" mode="aspectFill"></image>
			</view>
		</view>
		<view class="week">
